...
const Join: React.FC = () => {
  ...
  return (
    ...
    <div className="absolute inset-0 z-0 bg-gradient-to-b to-gray-900 via-gray-900 from-[#6633cc]/20"></div>
      <div className="container mx-auto px-6 text-center scroll-animate">
        ...
        <div className="mt-10 max-w-md mx-auto flex items-center bg-gray-900 rounded-lg p-2 border border-gray-700">
          ...
          <button 
            onClick={handleCopy}
            className={`font-bold py-2 px-6 rounded-md transition-all duration-300 ${copied ? 'cursor-not-allowed pointer-none bg-green-600 text-white' : 'cursor-pointer bg-[#6633cc] hover:bg-[#6633cc]/90'}`}
          >
